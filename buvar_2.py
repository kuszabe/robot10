...
def buvar(m, ml, mr, g, jobb_feltet, bal_feltet):
    #implement easing
    ...
    move(1000)
    turn(-50)
    bal_feltet.on_for_rotations(60, 4, block=False)
    move(220)
    sleep(1)
    bal_feltet.on_for_rotations(100, -3.3)

    turn(-87)
    move(70, speed=0.5, CORRECTION_NODIFIER=3)
    bal_feltet.on_for_rotations(100, -1.3)
    move(130, speed=0.5, CORRECTION_NODIFIER=3)
    ...
    bal_feltet.on_for_seconds(30, 0.8, block=False)
    move(-100, speed=0.3, startgyro=10, CORRECTION_NODIFIER=2)
    move(-1600, speed=1)
...
if __name__ == "__main__":
    ...
    try:
        buvar(m, ml, mr, g, jobb_feltet, bal_feltet)
    finally:
        m.off(brake=False)
